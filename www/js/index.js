    ...
    camera: {
      ...
      success: function(data) {
        if(!data.cancelled) {
          ...
          //basically loop through the children and match up data.text
          //then once we find the right person we set the current child
          //then resetToPage with the child stuff
